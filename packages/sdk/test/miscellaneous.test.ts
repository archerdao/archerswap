...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    ...
    const pair = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(tokenA, '0'), new TokenAmount(tokenB, '0'))
  ...
  it('getLiquidityMinted:!0', async () => {
    const tokenA = new Token(ChainId.RINKEBY, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(ChainId.RINKEBY, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(tokenA, '10000'), new TokenAmount(tokenB, '10000'))
  ...
  it('getLiquidityValue:!feeOn', async () => {
    const tokenA = new Token(ChainId.RINKEBY, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(ChainId.RINKEBY, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(tokenA, '1000'), new TokenAmount(tokenB, '1000'))
