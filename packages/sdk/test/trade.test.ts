...
describe('Trade', () => {
  ...
  const pair_0_1 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token0, JSBI.BigInt(1000)), new TokenAmount(token1, JSBI.BigInt(1000)))
  const pair_0_2 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token0, JSBI.BigInt(1000)), new TokenAmount(token2, JSBI.BigInt(1100)))
  const pair_0_3 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token0, JSBI.BigInt(1000)), new TokenAmount(token3, JSBI.BigInt(900)))
  const pair_1_2 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token1, JSBI.BigInt(1200)), new TokenAmount(token2, JSBI.BigInt(1000)))
  const pair_1_3 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token1, JSBI.BigInt(1200)), new TokenAmount(token3, JSBI.BigInt(1300)))

  const pair_weth_0 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, 
    new TokenAmount(WETH[ChainId.MAINNET], JSBI.BigInt(1000)),
    new TokenAmount(token0, JSBI.BigInt(1000))
  )

  const empty_pair_0_1 = new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, new TokenAmount(token0, JSBI.BigInt(0)), new TokenAmount(token1, JSBI.BigInt(0)))
